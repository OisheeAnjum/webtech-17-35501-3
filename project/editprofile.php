...
<?php
 ...
 { 
     ...
     $name = $_POST['name'];  
     $email = $_POST["email"];
  $sql = "UPDATE `customer_info` SET  user_name='$user_name',name='$name',email='$email' WHERE user_id='$user_id'";
         ...
         // $user_id = $_GET['user_id']; 
          $query ="select * from customer_info where user_id = '$user_id' limit 1";
